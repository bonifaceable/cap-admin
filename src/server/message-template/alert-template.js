...
// src/server/emails/referralBonusTemplate.js
export const ReferralBonusTemplate = ({
  ...
  <head>
    <meta charset="utf-8"/>
    <meta name="viewport" content="width=device-width,initial-scale=1"/>
    <title>Referral Bonus - ${brandName}</title>
  </head>
  <body style="margin:0;padding:0;background:#F6F7FB;">
    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background:#F6F7FB;">
      <tr>
        <td align="center" style="padding:24px 12px;">
          <table width="600" cellspacing="0" cellpadding="0" style="background:#fff;border-radius:12px;overflow:hidden;">
            ...
            <tr>
              <td style="padding:32px 24px;text-align:center;">
                <span style="display:inline-block;padding:8px 14px;border:1px solid #2563eb;border-radius:999px;background:#EFF6FF;color:#1d4ed8;font:600 14px Arial;">🎉 Referral Bonus Earned</span>
                <h1 style="margin:16px 0 12px;font:700 26px Arial;color:#111827;">Hi ${userName},</h1>
                <p style="margin:0 auto 20px;max-width:520px;font:400 16px/1.6 Arial;color:#374151;">
                  You just earned a <strong>$${amount}</strong> referral bonus. This bonus was awarded because someone you referred made a successful deposit.
                </p>
                <p style="margin:0 auto 20px;max-width:520px;font:400 14px/1.6 Arial;color:#6B7280;">
                  The bonus has been credited to your wallet. Thank you for helping grow the ${brandName} community.
                </p>
              </td>
            </tr>
...
// src/server/emails/depositApprovedTemplate.js
export const DepositApprovedTemplate = ({
  ...
  <head>
    <meta charset="utf-8"/>
    <meta name="viewport" content="width=device-width,initial-scale=1"/>
    <title>Deposit Approved - ${brandName}</title>
  </head>
  <body style="margin:0;padding:0;background:#F6F7FB;">
    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background:#F6F7FB;">
      <tr>
        <td align="center" style="padding:24px 12px;">
          <table width="600" cellspacing="0" cellpadding="0" style="background:#fff;border-radius:12px;overflow:hidden;">
            ...
            <tr>
              <td style="padding:32px 24px;text-align:center;">
                <span style="display:inline-block;padding:8px 14px;border:1px solid #16a34a;border-radius:999px;background:#ECFDF5;color:#166534;font:600 14px Arial;">✅ Deposit Approved</span>
                <h1 style="margin:16px 0 12px;font:700 26px Arial;color:#111827;">Hi ${userName},</h1>
                <p style="margin:0 auto 20px;max-width:520px;font:400 16px/1.6 Arial;color:#374151;">
                  Your deposit of <strong>$${amount}</strong> has been <strong>approved</strong>.
